      ...
      <Row className="justify-content-center">
        <Col lg={10} xl={12}>
            ...
            <Col lg={6} xl={5} className="my-auto">
              <Row>
                <Col>
                  <Row>
                    <Col>
                      <h4 className="title__text text-right">Brain Games </h4>
                    </Col>
                  </Row>
                  <Row>
                    <Col>
                      <p className="sub__text text-right">
                        I had the idea to develop types of mini game that can
                        test the users basic gaming skills. Inspired by
                  ...
                  <Row className="justify-content-end">
                    <Col xs={2} sm={2} md={1} lg={2} xl={2}>
                      <a
                        href="https://github.com/grandonbarcia/mini-games"
                        target="_blank"
                        rel="noreferrer"
                      >
                    ...
                    <Col xs={2} sm={2} md={1} lg={2} xl={2}>
                      <a
                        href="https://focused-bassi-d58606.netlify.app/"
                        target="_blank"
                        rel="noreferrer"
                      >
          ...
          <Row className="project__row">
            <Col className="project__image__col" lg={6} xl={6}>
              <Image
                className="project__image shadow-lg"
                src={HabitTracker}
                width={"100%"}
                height={"100%"}
              />
            ...
            <Col lg={6} xl={{ span: 5, offset: 1 }} className=" my-auto">
              ...
              <p className="sub__text">
                I wanted to improve my lifestyle a bit by adding some habits
                that may be beneficial, like meditating and stretching. After a
                while, I had a hard time keeping track of how many times I did
              ...
              <Row className="justify-content-start">
                ...
                <Col xs={2} sm={2} md={1} lg={2} xl={2}>
                  <a
                    href="https://epic-bell-c4bb6e.netlify.app/"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <HiOutlineDesktopComputer size={32} />
              ...
              <Row>
                <Col>
                  ...
                  <p className="sub__text text-right">
                    ...
                    (words per minute) will be displayed. I challenge you to
                    beat your best! Working on implementing a graph to display
                    user's past scores.{" "}
                  </p>
                  <Row className="justify-content-end">
                    <Col xs={2} sm={2} md={1} lg={2} xl={2}>
                      <a
                        href="https://github.com/grandonbarcia/typing-test"
                        target="_blank"
                        rel="noreferrer"
                      >
                        <AiOutlineGithub size={32} />
                    ...
                    <Col xs={2} sm={2} md={1} lg={2} xl={2}>
                      <a
                        href="https://vigilant-spence-6f0b27.netlify.app/"
                        target="_blank"
                        rel="noreferrer"
                      >
                        <HiOutlineDesktopComputer size={32} />{" "}
